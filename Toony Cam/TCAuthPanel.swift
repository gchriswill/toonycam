...
class TCAuthPanel: UIView {
    ...
    @IBOutlet weak var delegate: TCAuthPanelDelegate!
...
extension TCAuthPanel {
    ...
    func animateOptionsPanel(direction:Direction) {
        self.isAnimating = true
        self.delegate.didStartanimatingOptionsPanel()
        ...
        UIView.animate(withDuration: 0.75,
            ...
            self.delegate.didFinishAnimatingOptionsPanel()
        }
    }
    ...
    internal func resetOptionsPanel() {
        self.controlPanelMover.constant = 600
        self.controlPanelSlider.constant = 0
        self.superview?.layoutIfNeeded()
    }
