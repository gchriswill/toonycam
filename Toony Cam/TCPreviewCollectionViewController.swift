//
//  TCPreviewCollectionViewController.swift
//  Toony Cam
//
...
private let reuseIdentifier = "TC_FILTERS_CELL_2"


// TODO: Change name to TCPreviewFilterCollectionViewController
class TCPreviewCollectionViewController: UICollectionViewController {
    
    var previewCellIndex:IndexPath!
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        for i in collectionView!.visibleCells {
            ...
            if let e = i as? TCFiltersCollectionViewCell {
